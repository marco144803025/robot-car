...
void pwms(unsigned, unsigned, char), sr04(unsigned);
char getPath(void);
...
//  TIM2->CR1 = TIM4->CR1 = TIM_CR1_CEN;  //turn on timers
  TIM1->CR1 = TIM_CR1_CEN; // open it ---->(uart_3 not work)
}
...
/*
extern "C" void TIM1_UP_IRQHandler(void) {           // may have error
